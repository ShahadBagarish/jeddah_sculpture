...
import { Button, Form,  Jumbotron, Col, Container, Alert } from 'react-bootstrap';
    ...
    render() {
        return (
            <div>
                ...
                {(!localStorage.apiKey)? <Alert variant="danger" >
                            <Alert.Heading>Oh snap! You are not unauthorized!</Alert.Heading>
                            <p>signup or login to Jeddah sculpture website </p>
                        </Alert> : <div>
